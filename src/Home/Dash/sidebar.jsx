...
const Sidebar = () => {
  ...
  return (
    <div className="w-64 bg-gradient-to-b from-indigo-900 via-indigo-800 to-indigo-700 text-white p-6 min-h-screen shadow-2xl flex flex-col">
      <div className="text-center mb-10">
        {user?.photoURL ? (
          ...
          <div className="w-24 h-24 rounded-full mx-auto mb-4 bg-indigo-700 flex items-center justify-center text-4xl font-extrabold shadow-xl border-4 border-white">
            {user?.displayName?.charAt(0)?.toUpperCase() || "U"}
          </div>
        )}
        <p className="text-xl font-semibold truncate">{user?.displayName || "User"}</p>
      ...
      {role === "user" && (
        <>
          <h2 className="text-lg font-bold mb-5 border-b border-white pb-2 tracking-wide">
            User Menu
          </h2>
