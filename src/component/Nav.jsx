...
//   // if (loading) {
//   //   return (
//   //     <nav className="bg-white border-b border-gray-100 sticky top-0 z-50 backdrop-blur-sm bg-opacity-90 text-center shadow-md max-w-full">
...
//   return (
//     <nav className="bg-white border-2 sticky top-0 z-50 backdrop-blur-sm bg-opacity-90 shadow-sm">
