...
const ScholarshipDetails = () => {
  ...
  const {
    ...
    queryFn: async () => {
      const res = await axios.get(
        `http://localhost:5000/reviews?scholarshipId=${id}`
      );
      return res.data;
    },
  });
  ...
  return (
    <div className="p-6">
      ...
      />
      <p>
        <b>Category:</b> {scholarship.scholarshipCategory}
      </p>
      <p>
        <b>Location:</b> {scholarship.universityCity},{" "}
      ...
      <p>
        <b>Fees:</b> ${scholarship.applicationFees}
      </p>
      <p className="my-4">{scholarship.scholarshipDescription}</p>
